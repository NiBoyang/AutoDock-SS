...
# to_be_screened = set(os.listdir("/root/autodl-tmp/consensus_map/"))
to_be_screened = ["abl1_rec"]
for dude_target in to_be_screened:
    ...
    lib_path = f'/root/autodl-tmp/consensus_map/{dude_target}/docking_test/lib/' # directory of your VS library
    lig_path = f'/root/autodl-tmp/consensus_map/{dude_target}/docking_test/lig/' # directory of your reference ligand
    ...
    #======================================================================================================================
    ##
    # Decompress the VS library and split it into single molecules (used for user input)
    ##
    #======================================================================================================================
...
center    {center[0]:.3f} {center[1]:.3f} {center[2]:.3f}\
    ...
    #======================================================================================================================
    ##
    # Creating ligand-based grid maps for the reference
    ##
    #======================================================================================================================
...
#     print("Finished creating map files")
    #======================================================================================================================
    ##
    # Convert VS library ligands into PDBQT, add polar H, and atomic partial charges
    # Call AutoDock-GPU for LBVS
    ##
    #======================================================================================================================
    ...
    #======================================================================================================
    ##
    # Extract best pose and Normalization of similarity score, and write ranking file
    ##
    #======================================================================================================
